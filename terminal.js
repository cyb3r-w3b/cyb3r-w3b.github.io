...
(function ( $ ) {
  ...
  function Terminal(tag, user, hostname, path, mode, programs){
    console.log("create terminal Cyb3r.W3B");
  ...
  *************/
  Terminal.prototype.getPrompt = function(){
    return this.user+"<a style='color:red;'>@</a>"+this.host+this.path+this.mode;
  }
  ...
  *************************/
  ...
  Terminal.prototype.executeCommand = function(){
    ...
    if (typeof this.programs[program] == 'function') {
      ...
      self.printa("<d style='color:red; font-size:15px;'>No command error</d>");
    }
